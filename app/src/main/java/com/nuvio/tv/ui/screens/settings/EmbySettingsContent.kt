                ...
                if (authState.isConnected) {
                    ...
                    item(key = "emby_test_connection") {
                        Row(
                            ...
                            val resultText = connectionResultText(uiState.connectionResult)
                            if (resultText != null) {
...
@Composable
private fun connectionResultText(result: EmbyConnectionResult?): String? = when (result) {
    is EmbyConnectionResult.MissingCredentials ->
        stringResource(R.string.emby_test_result_missing_credentials)
    is EmbyConnectionResult.ConnectionFailed ->
        stringResource(R.string.emby_test_result_connection_failed, result.code, result.message)
    is EmbyConnectionResult.FetchUsersFailed ->
        stringResource(R.string.emby_test_result_fetch_users_failed, result.serverName)
    is EmbyConnectionResult.NoUsers ->
        stringResource(R.string.emby_test_result_no_users, result.serverName)
    is EmbyConnectionResult.Success ->
        stringResource(
            R.string.emby_test_result_success,
            result.serverName,
            result.userName ?: stringResource(R.string.emby_test_result_unknown_user)
        )
    is EmbyConnectionResult.NetworkError ->
        stringResource(R.string.emby_test_result_network_error, result.message.orEmpty())
    null -> null
}
