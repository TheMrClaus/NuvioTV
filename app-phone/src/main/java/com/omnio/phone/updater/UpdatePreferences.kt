...
private val Context.phoneUpdateDataStore: DataStore<Preferences> by preferencesDataStore(name = "phone_update_settings")

@Singleton
class UpdatePreferences @Inject constructor(
    @ApplicationContext private val context: Context
) {
    private val dataStore = context.phoneUpdateDataStore
